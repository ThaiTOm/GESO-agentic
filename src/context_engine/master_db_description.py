...
Bảng dữ liệu này thể hiện thông tin bán hàng chi tiết của công ty OPC. 
Thông tin bao gồm: mã khách hàng, tên và địa chỉ nhà thuốc, mã và tên sản phẩm, ngành hàng, nhãn hàng, đơn vị tính, kho xuất hàng, hợp đồng, cùng với doanh số trước VAT, tiền VAT và doanh số sau VAT.
...
Các cột chi tiết trong bảng dữ liệu bao gồm:
    ...
    MAGSBH: Mã định danh của giám sát bán hàng, người trực tiếp quản lý và hỗ trợ nhân viên bán hàng.
    GIAMSATBANHANG: Tên Giám sát bán hàng, giám sát bán hàng quản lý nhân viên bán hàng.
    MANVBH: Mã định danh nhân viên bán hàng, trình dược viên, đại diện kinh doanh.
    NHANVIENBANHANG: Tên nhân viên phụ trách bán hàng,  trình dược viên, đại diện kinh doanh.
    MAKHACHHANG: mã khách hàng trong hệ thống.
    ...
    GAMHANG: Mã gam hàng
    MASANPHAM: Định danh duy nhất cho từng SKU, đơn vị cơ bản để quản lý tồn kho, bán hàng.
