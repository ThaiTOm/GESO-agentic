...
async def reformulate_query_with_chain(query: str, chat_history: List[Dict], user_id:str, user_role:str) -> str:
    ...
    return f"Tôi là user: {user_id}, vai trò của tôi khi truy vấn: {user_role}. {reformulated.strip()}."